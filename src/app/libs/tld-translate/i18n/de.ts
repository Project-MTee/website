...
export const i18n_de: ILocalization = {
  ...
  "TLD_TRANSLATE": {
    ...
    "CANCEL_TRANSLATION": "Abbreche",
    "FILE_TARGET_PREVIEW_MESSAGE": "Dies ist eine Vorschauprobe des übersetzten Dokuments. Bitte laden Sie es herunter, um die vollständige Übersetzung zu erhalten.",
    "FILE_UPLOAD_UNSUPPORTED_FORMAT": "Das Dateiformat \\{{fileName}}\\\" wird nicht erkannt. Für die folgenden Dokumentformate wird die Übersetzung unterstützt: {{formats}}.",
    "FILE_UPLOAD_MAX_SIZE": "Die Datei \"{{fileName}}\" ist zu groß. Die maximale Dateigröße beträgt {{maxSizeMB}}.",
    "FILE_UPLOAD_EMPTY": "Die Datei \"{{fileName}}\" ist leer. Bitte wählen Sie eine Datei mit Inhalt.",
    "FROM": "Von:",
    "SOURCE_TOOLTIP": "Geben Sie den Text oder die Webseite ein, die Sie übersetzen möchten.",
    "TARGET_DESCRIPTION": "Eine maschinelle Übersetzung wird ein gutes Verständnis des Ausgangstextes vermitteln, kann aber eine von einem Menschen erstellte Übersetzung nicht ersetzen.",
    "TO": "An:",
    "TEXT_COPIED": "Kopierte Übersetzung",
    "TOOLTIP_ACTION": "Übersetzung",
    "DOMAINS_ARIA_LABEL": "Domänen",
    "ERROR_NO_SYSTEMS_LOADED": "Es wurden keine Systeme geladen.",
    "FILE_TANSLATION_STATUSS_INITIALIZING": "Übersetzungsprozess wird initialisiert...",
    "FILE_TANSLATION_STATUSS_EXTRACTING": "Übersetzbarer Inhalt wird extrahiert...",
    "FILE_TANSLATION_STATUSS_WAITING": "Translator wird gestartet...",
    "FILE_TANSLATION_STATUSS_TRANSLATING": "Übersetzung wird durchgeführt...",
    "FILE_TANSLATION_STATUSS_SAVING": "Übersetzung wird gespeichert...",
    "FILE_TANSLATION_STATUSS_QUEUING": "Übersetzung beginnt...",
    "UPLOAD_FILES_BUTTON": "Dateien hochladen oder ziehen"
  },
  "LANGUAGES": {
    "EN": "Englisch",
    "LV": "Lettisch",
  ...
  "ARIA_LABELS": {
    ...
    "CLEAR_NOTIFICATION": "Alarmmeldung schließen",
